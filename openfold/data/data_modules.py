...
class OpenFoldSingleMultimerDataset(torch.utils.data.Dataset):
    ...
    def _parse_mmcif(self, path, file_id, alignment_dir, alignment_index):
        ...
        mmcif_object = mmcif_parsing.parse(
            file_id=file_id[:4], mmcif_string=mmcif_string
        )
        ...
        mmcif_object = mmcif_object.mmcif_object
        mmcif_object.header["resolution"] = self.mmcif_data_cache[file_id]["resolution"]
    ...
    def __len__(self):
        return len(self.mmcif_data_cache) 
